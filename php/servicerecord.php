						...
						<div class="panel panel-default">
							<div class="panel-heading">Enter Enter Service Record
								...
								<div class="panel-body">
									...
									<div class="col-sm-4">										
                    					<form name="servicerecord" class="form-style-9" method="post" action="" enctype="multipart/form-data"">
											<ul>
                                                <li>
						  							<label class="label-style label-split align-left">Date of Service</label>
                                					<input id="stadate" name="stadate" type="date" class="field-style field-split align-right" required="true"/>   
						  						</li>  
                                                <li>
													...
													<select type="text" class="field-style align-right" name="txtVehCat" width="208" placeholder="Select Vehicle Category">
                                    					<?php
															$sqldr = "SELECT id, regnumber from fleetmain order by id ";
                                                ...
                                                <li>
													...
													<input style="text-transform: uppercase;" type="text" name="txtCompName" class="field-style field-split align-right" placeholder="Service Odometer" required="true" />
                          						</li>
                          						<li>
						  							<label class="label-style label-split align-left">Garage</label>
						  							<input style="text-transform: uppercase;" type="text" name="txtContPer" class="field-style field-split align-right" placeholder="Garage" required="true"/>
						 	 					</li>
						  						<li>
						  							<label class="label-style label-split align-left">Location</label>
						  							<input type="text" name="txtPhoneNum" class="field-style field-split align-right" placeholder="Garage Location" required="true"/>
						  						</li>
											</ul>
											<ul>
												<li>
													...
													<select type="text" class="field-style align-right" name="txtVehCat" width="208" placeholder="Select Vehicle Category">
                                    					<?php
															$sqlservdr = "SELECT id, fullname from drivers order by id ";
						  						...
						  						<li>
                              						...
                              						<textarea style="text-transform: uppercase;" name="txtRemarks" class="field-style field-split align-right" placeholder="Service Details" rows="6" cols="40"></textarea>
                          						</li>
												<li>
													<label class="label-style label-split align-left">Amount Charged</label>
													<input type="text" name="cAmount" class="field-style field-split align-right" placeholder="Amount Spent" required="true"/>
												</li>			
											</ul>
											<ul>
						  						<li>
													<table id="zttc" class="display table table-striped table-bordered table-hover" cellspacing="0" width="50%">
														<tr>
															<td>
																<button type="submit" name="enterservicerecord" id="enterservicerecord" class="btn btn-md btn-primary active">ENTER SERVICE RECORD</button>
