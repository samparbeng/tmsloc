								...
								<div class="row">
									<div class="col-sm-12">
										<table id="zctb" class="display table table-responsive table-striped table-bordered table-hover" cellspacing="0" width=100%">
											...
											<tbody>
												<?php $sql = "SELECT PONumber, PODate, VendorName, POQty, PODescription, POUnit, POUP, POTotal
                                                 POUser FROM po WHERE VendorNmae='.$specvendor.' ORDER BY PONumber";
