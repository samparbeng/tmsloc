						...
						<div class="panel panel-default">
							<div class="panel-heading">Modify Reservations
								...
								<div class="panel-body">
                                    ...
                                    ?>
                                        <form name="resEntry" class="form-style-9" method="post" action="procmod.php" enctype="multipart/form-data"">
											<ul>
                          						<li>
											...
											<ul>
						  						<li>
                              						...
                              						<textarea style="text-transform: uppercase;" name="txtRemarks" class="field-style field-split align-right" rows="6" cols="40"><?php echo $row2['remarks'];?></textarea>
                          						</li>
											</ul>
											<ul>
						  						<li>
													<table id="zttc" class="display table table-striped table-bordered table-hover" cellspacing="0" width="50%">
														<tr>
															<td>
																<input type="hidden" name="resmodin" id="resmodin" value="<?php echo $row2['mypr'];?>"/>
																<button type="submit" name="modres" id="entres" class="btn btn-md btn-primary active">SAVE CHANGES</button>
