				...
				<div class="row">
					...
					<h2 class="page-title">Reservations</h2>
						...
						<div class="panel panel-default">
							<div class="panel-heading">Enter Reservations
							</div>
								<div class="panel-body">
									<div class="row row-no-gutters">
									<div class="col-sm-7">										
                    					<form name="resEntry" class="form-style-9" method="post" action="procres.php" enctype="multipart/form-data"">
											<ul>
                          						<li>
												...
												<li>
													...
													<select type="text" class="field-style align-right" name="txtVehCat" width="208" placeholder="SELECT VEHICLE CATEGORY">
                                    					<?php
															...
															echo strtoupper('<option value="" disabled selected>SELECT VEHICLE CAT</option>');
						  						...
						  						<li>
													...
													<input id="stadate" name="stadate" type="text" class="date-picker field-style field-split align-right"/>
												</li>
						  						<li>
						  							<label class="label-style label-split align-left">End Date</label>
													<input id="enddate" name="enddate" type="text" class="date-picker field-style field-split align-right"/>
												</li> 		
						  						<li>
						  							<label class="label-style label-split align-left">Duration</label>
						  							<input value=""  type="number"  class="field-style field-split align-right" name="txtDur" id="txtDur"/>
												  </li>
                          						<li>
											...
											<ul>
						  						<li>
													<table id="zttc" class="display table table-striped table-bordered table-hover" cellspacing="0" width="50%">
														<tr>
															<td>
																<button type="submit" name="entres" id="entres" class="btn btn-md btn-primary active">ENTER RESERVATION</button>
