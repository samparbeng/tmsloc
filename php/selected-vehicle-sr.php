						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
										...
										<tbody>
									<?php $sqlsv = "SELECT id, servicedate, servicevehicle, serviceodo, servicegarage, glocation, servicedriver, serviceuser FROM servicerecords WHERE servicevehicle='".$serveveh."' order by servicedate ";
                                    
									$query = $dbh -> prepare($sqlsv);
									$query->execute();
