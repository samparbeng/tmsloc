				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">View Closed Reservations</div>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT ashase, awie, compname, duration, destination, assignedvehicle, assigneddriver, confirm, mypr from reservations WHERE confirm = 'Closed' order by ashase";
									$query = $dbh -> prepare($sql);
									$query->execute();
