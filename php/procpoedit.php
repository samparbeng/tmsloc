...
if ($_SERVER['REQUEST_METHOD'] ==='POST')
{
    ...
    if(isset($_POST["updateporec"]))
    {
		// the request method is fine
        $ponumberedit = trim($_POST['eponumber']);
        $thiscompany = "ALABASTER CAR RENTALS";
        ...
        $sql = "UPDATE po SET PODate='$orderdate', VendorName='$ordervendorname', POQty='$orderquantity', PODescription='$orderdetails', 
        POUnit='$orderunitpx', POTotal='$ordertotalpx', POUser='$pouser', DeliverTo='$thiscompany'
	    WHERE PONumber='$ponumberedit'";
	    if (mysqli_query($conn, $sql)){
		$msg ="This Purchase Order has been successfully modified";
	    }else{
		$msg ="Error modifying this Purchase Order: ". mysqli_error($conn);
	}
	mysqli_close($conn);
