...
class Invoice{
	...
	public function loginUsers($username, $password){
		$sqlQuery = "
			SELECT id, UserEmail, FirstName, LastName, Address, Mobile 
	...
	public function getItemList(){
		$sqlQuery = "
			SELECT * FROM ".$this->invoiceItemTable." ORDER BY id";
		$result = mysqli_query($this->dbConnect, $sqlQuery);
